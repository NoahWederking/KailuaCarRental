...
public class Customer {
    ...
    public void updateCustomer(Controller controller) {
        ...
        controller.setupNCon("SELECT customer_fullname, customer_address, customer_city," +
                ...
                "FROM customer WHERE customer_id LIKE" + "'" + customerId + "'");
    ...
    public void addCustomer(Controller controller) {
        System.out.println("Please input customers Full name (Firstname & Lastname)");
        ...
        String sql = String.format("INSERT INTO customer VALUES(NULL, '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')",
                fullName, customer_address, customer_city, customer_mobile, customer_phone, customer_email,
